...
# 51 Xác định đường contour có diện tích lớn nhất của ảnh Ib.Vẽ đường contour trên ảnh gốc I.
...
#     if cv2.contourArea(contour) > (max /(1.2)):
#         cv2.drawContours(I_copy_3, [contour], -1, (0, 255, 255), 3)



# # Tìm contour có dien tich lớn nhất
...
cv2.imshow("anh contours co DT > DTLN/3", I_copy_3)
