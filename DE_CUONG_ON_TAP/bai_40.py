...
# 40 Nhị phân hóa của ảnh 255-Is theo ngưỡng Otsu được ảnh nhị phân Ib. 
# Xác định đường contour có chu vi lớn nhất của ảnh Ib. Vẽ đường contour trên ảnh gốc I và hiển thị ảnh I.
