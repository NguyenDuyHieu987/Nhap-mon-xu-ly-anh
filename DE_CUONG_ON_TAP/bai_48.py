...
# 48 Xác định các đường contour của ảnh Ib, tìm giá trị max_chuvi là chu vi lớn nhất trong các contour trên. 
# Vẽ các contours có chu vi > max_chuvi/3.0 lên ảnh gốc I.
