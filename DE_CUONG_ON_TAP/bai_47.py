...
# 47 Xác định các đường contour của ảnh Ib, tìm giá trị max_area là diện tích lớn nhất trong các contour trên. 
# Vẽ các contours có diện tích > max_area/5.0 lên ảnh gốc I với mầu vàng bgr = (0, 255, 255). Hiển thị ảnh I
...
# print(f"vi tri contour co dien tich lon nhat: {max_area}")
cnt = contours[max_area]
# print(f"gia tri contour co dien tich lon nhat: {areas[max_area]}")
...
cv2.imshow("anh contours co DT > DTLN/5", I_copy_3)
