...
# 37 Nhị phân hóa ảnh 255- Is (ảnh nghịch đảo) theo ngưỡng Otsu được ảnh nhị phân Ib. 
# Xác định đường contour có chu vi lớn nhất của ảnh Ib. # Vẽ đường contour trên ảnh gốc I.
