...
# 32 Lấy biên của ảnh Ig theo phương pháp Canny được ảnh biên Ie là ảnh nhị phân nền đen. 
# Kiểm tra các điểm ảnh của pixel có tọa độ dòng y=160, cột x=326 có phải là điểm biên của Ig theo phương pháp dò biên Canny.
